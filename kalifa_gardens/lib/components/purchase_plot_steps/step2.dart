...
class _PurchasePlotStep2State extends State<PurchasePlotStep2> {
  ...
  String _nameOfEntity = 'XYZ Corp', _rcNo = 'RC252414', _surname='Boethe', _otherNames='Chizoma', _emailAddress = 'investments@xyz.corp', _nameSublease = 'XYZ Corp Real Estate Fund',
      _addressSublease = '1, Glover Street, Ikoyi, Lagos', _plotSize='600SQM', _plotQuantity = '2';
          ...
          Column(
            children: [
              Container(
                ...
                child: SvgPicture.asset('assets/images/offer_accepted_img.svg'),
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 21.0, horizontal: 32.0),
                    child: Text(
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: 'Egestas eget laoreet molestie sed eleifend nibh. Amet ipsum pellentesque sit magna enim, neque. Consectetur lobortis aliquam ut consectetur. Nunc, et, nibh vel cum. Commodo, ultrices id laoreet urna faucibus. Lacus turpis et tristique vulputate sit pharetra.'
