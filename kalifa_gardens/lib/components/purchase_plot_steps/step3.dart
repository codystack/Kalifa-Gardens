import 'package:demo_app/components/purchase_plot_payments/pay_draft.dart';
import 'package:demo_app/components/purchase_plot_payments/pay_transfer.dart';
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            SvgPicture.asset('assets/images/pay_transfer.svg'),
                            SizedBox(width: 10.0,),
                            Text(
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            SvgPicture.asset('assets/images/pay_draft.svg'),
                            SizedBox(width: 10.0,),
                            Text(
                              'Pay with Bank Draft',
                              style: TextStyle(
