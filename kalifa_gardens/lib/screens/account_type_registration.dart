...
import 'package:demo_app/screens/corporate_registration.dart';
...
class AccountTypeRegistration extends StatefulWidget {
  ...
  @override
  _AccountTypeRegistrationState createState() => _AccountTypeRegistrationState();
}
                          ...
                          Container(
                            decoration: BoxDecoration(
                              color: Color(0x3B0A4D50),
                                border: Border.all(color: Color(0xFF0A4D50), width: 1.0, style: BorderStyle.solid),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (_isCorporate) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => CorporateRegistration()),
                        );
                      }
                      else if (_isIndividual) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => IndividualRegistration()),
                        );
                      }
                    },
